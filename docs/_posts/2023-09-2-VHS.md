...
<h4 style="color: DodgerBlue; text-align: center;"> Ecco un esempio d'interfaccia grafica </h4>

<div style="display: flex; align-items: center; gap: 20px;">
   <img src="https://hd2.tudocdn.net/497374" style="width: 70%; min-width: 120px; mix-blend-mode: multiply;"><br><br>
 </div>

<h5 style="color: FireBrick;"> Grazie a questo dispositivo riguardare i propri ricordi non è mai stato così semplice! 
